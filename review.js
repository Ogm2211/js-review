...
let fullName  = "Yilmaz " + myName
// 5.) Use any of the variables above or create new ones and print using string interpolation
let surname = "Yilmaz"
console.log(`Surname is ${fullName}`)
// ================ Variable Names =================
/* 
...
console.log(surname.startsWith('Y'))
// Now use any variable with endsWith() and return false
console.log(myName.endsWith("k"))
// Finish the following sentence. Use includes() and return true.
const ozgur = 'Once upon a time Ozgur looked up at the Moon, saw the Moon :)'
...
console.log("     This is example of trim      ".trim())
// =================================================
//                     BOOLEAN
// =================================================
...
for(let i = 0 ; i<10 ; i++){ console.log("The room has been spinning like crazy")}
...
const lana = ['l', 'a', 'n', 'a']
for( arely in lana){ console.log(arely)}
// USE (FOR OF LOOP)!
...
console.log(participants)
// slice()
console.log("This is slice from -2", participants.slice(-2))
// sort()
console.log("This is a sort", participants.sort())
// includes()
console.log("Is it includes Ozgur" , participants.includes("Ozgur"))
// indexOf()
console.log("What is the Index of Swathi", participants.indexOf('Swathi'))
// length
console.log("Length of participant array is", participants.length)
...
// Remove orange
fruits.pop()
console.log("Print after remove orange", fruits)
// Add strawberry, kiwi, and grapes at the end
fruits.push("strawberry","kiwi","grapes")
console.log("Print after adding strawberry,kiwi and grapes at the end", fruits)
// Remove apple
fruits.shift()
console.log("Print after shift", fruits)
// Add mango at the beginning of the array
fruits.unshift("mango")
console.log("Print after unshift mango", fruits)
// Add lemon, and grapefruit between mango and banana
fruits.splice(1,0,'lemon','grapefruit')
console.log('Print after adding lemon and grapefruit after mango with splice', fruits)
// Remove banana and strawberry
fruits.splice(3,2)
console.log('Print after remove banana and strawberry with splice', fruits)
...
let exoticFruits = ['Durian','Lucuma','Sapodilla']
let allFruits = fruits.concat(exoticFruits)
// Print the last two exotic fruits without altering the newly concatenated array.
console.log('These are the all concaneted fruits', allFruits)
console.log('Print the last two exotic fruits',allFruits.slice(-2))
...
gustavo === "coolest" ? console.log("You got that right!") : console.log("James wants to argue. He says he's the bet!")
...
let fightClub = name => {
  switch(name){
    case 'Teo': return '1st rule: You do not talk about Fight Club.'
    case 'Manara': return '2nd rule: YOU DO NOT TALK ABOUT FIGHT CLUB.'
    case 'Liv': return '3rd rule: If someone yells "Stop!", goes limp, taps out, the fight is over.'
    case 'Devin': return '4th rule: Only two guys to a fight.'
    default: 'No shirts'
  }
}
